...
import com.qa.ims.persistence.dao.OrderItemDaoMysql;
...
public class Ims {
	...
	public void imsSystem() {
		...
		case ORDERITEM:
			OrderItemController orderItemController = new OrderItemController(
					new OrderItemServices(new OrderItemDaoMysql(username, password)));
			doAction(orderItemController, action);
			break;
		case STOP:
			break;
		default:
	...
	public void init(String username, String password) {
		init("jdbc:mysql://jdbc:mysql://34.89.15.11:3306/", username, password, "src/main/resources/sql-schema.sql");
	}
